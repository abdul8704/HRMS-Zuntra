    ...
    <>
      ...
      >
        {(sidebarState === 2 || sidebarState === 3) && (
          <div
            className="absolute top-4 right-4 cursor-pointer p-2 rounded-full hover:bg-white/20 transition-all duration-200 z-50"
          ...
          >
            {sidebarState === 2 ? (
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="none" viewBox="0 0 34 34">
                ...
                <defs>
                  <clipPath id="a">
                    <path fill="#fff" d="M.03 17 17 .03 33.971 17l-16.97 16.97z" />
                  </clipPath>
                </defs>
              </svg>
            )}
