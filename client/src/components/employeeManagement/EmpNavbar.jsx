    ...
    <div className="emp-navbar">
      <div className="nav-buttons">
        ...
        <button className="btn icon-btn">
          <svg xmlns="http://www.w3.org/2000/svg" width="1.5625rem" height="2.375rem" fill="none" viewBox="0 0 38 38">
