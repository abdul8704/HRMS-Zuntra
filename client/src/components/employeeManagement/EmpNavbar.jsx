    ...
    <div className="emp-navbar">
      <div className="nav-buttons">
        ...
        <button className="btn icon-btn">
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" viewBox="0 0 38 38">
            <path d="M19 22.167a6.34 6.34 0 0 0 6.334-6.334A6.34 6.34 0 0 0 19 9.5a6.34 6.34 0 0 0-6.333 6.333A6.34 6.34 0 0 0 19 22.167Zm0-9.5a3.17 3.17 0 0 1 3.167 3.166A3.17 3.17 0 0 1 19 19a3.17 3.17 0 0 1-3.166-3.167A3.17 3.17 0 0 1 19 12.667Z"/>
            <path d="M18.081 34.538a1.583 1.583 0 0 0 1.837 0c.482-.34 11.794-8.509 11.748-18.705 0-6.984-5.682-12.667-12.666-12.667S6.333 8.849 6.333 15.825C6.287 26.029 17.6 34.198 18.081 34.538ZM19 6.333c5.24 0 9.5 4.26 9.5 9.508.033 7.026-6.948 13.336-9.5 15.405-2.55-2.07-9.533-8.382-9.5-15.413 0-5.24 4.26-9.5 9.5-9.5Z"/>
          </svg>
        </button>

        {/* Filter Button */}
        <button className="btn icon-btn">
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="25" fill="currentColor" viewBox="0 0 30 30">
