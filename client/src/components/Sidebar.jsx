  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M11.465.42a4.158 4.158 0 0 1 3.640 0l10.56 5.131c.184.90.340.230.449.406a1.132 1.132 0 0 1 .010 1.180c-.107.178-.260.322-.442.414l-10.508 5.347a4.16 4.16 0 0 1-3.778 0L2.452 8.347v4.986c0 .295-.114.578-.317.786a1.07 1.07 0 0 1-.766.325 1.07 1.07 0 0 1-.766-.325 1.126 1.126 0 0 1-.317-.786V6.611a1.13 1.13 0 0 1 .153-.626c.110-.189.272-.340.466-.434l10.56-5.130ZM4.62 11.931v3.625a1.136 1.136 0 0 0 .318.786l.005.007.050.047.130.124c.108.104.265.242.470.416.405.340.990.788 1.720 1.240 1.451.890 3.540 1.824 5.973 1.824s4.524-.933 5.973-1.824a14.55 14.55 0 0 0 2.193-1.656l.130-.124.034-.036.013-.013.003-.003.004-.002a1.115 1.115 0 0 0 .316-.786v-3.627l-5.815 2.960a6.281 6.281 0 0 1-2.851.686 6.28 6.28 0 0 1-2.851-.686L4.62 11.931Z"
        />{" "}
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        ...
        <g clipPath="url(#a)">
          ...
          <path
            fill="currentColor"
            d="M23.066 3.889h-1.781v1.556h1.555v19.444H5.729V5.445h1.555V3.889H5.73a1.361 1.361 0 0 0-1.556 1.314V25.13a1.322 1.322 0 0 0 1.33 1.315h17.563a1.323 1.323 0 0 0 1.33-1.315V5.203a1.324 1.324 0 0 0-1.33-1.314Z"
          />{" "}
          <path
            fill="currentColor"
            d="M20.507 5.7a1.82 1.82 0 0 0-1.813-1.812h-1.4a3.111 3.111 0 0 0-6.027 0H9.874A1.82 1.82 0 0 0 8.062 5.7v2.855h12.445V5.7ZM18.95 7H9.618V5.7a.257.257 0 0 1 .256-.256h2.855v-.778a1.556 1.556 0 0 1 3.111 0v.778h2.855a.257.257 0 0 1 .256.256V7ZM8.84 10.889h10.89v1.555H8.84V10.89Zm0 3.111h10.89v1.556H8.84V14Z"
          />{" "}
  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M29.284 1.2v21.6c0 .318-.084.623-.234.848-.15.226-.353.352-.566.352h-22.4c-.212 0-.415-.126-.565-.352a1.553 1.553 0 0 1-.235-.848c0-.318.085-.623.235-.849.15-.225.353-.351.565-.351h4.8v-6c0-.318.085-.623.235-.848.15-.226.353-.352.565-.352h4.8v-6c0-.318.085-.623.235-.849.15-.225.353-.351.565-.351h4.8v-6c0-.318.085-.623.235-.849.15-.225.353-.351.565-.351h5.6c.213 0 .416.126.566.351.15.226.234.53.234.849Z"
        />{" "}
        <path
          fill="currentColor"
          d="M10.354 0h4a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.854.354l-1.646-1.647L.708 14.854 0 14.146 11.647 2.5 10 .854A.5.5 0 0 1 10.354 0Z"
        />{" "}
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        ...
        <path
          fill="#000"
          fillRule="evenodd"
          d="M10.25.5A.25.25 0 0 0 10 .25H3A2.75 2.75 0 0 0 .25 3v14A2.75 2.75 0 0 0 3 19.75h10A2.75 2.75 0 0 0 15.75 17V7.147a.25.25 0 0 0-.25-.25H11a.75.75 0 0 1-.75-.75V.5Zm.75 9.75a.75.75 0 1 1 0 1.5H5a.75.75 0 1 1 0-1.5h6Zm0 4a.75.75 0 1 1 0 1.5H5a.75.75 0 1 1 0-1.5h6Z"
          clipRule="evenodd"
        />{" "}
        <path
          fill="#000"
          d="M11.75.823c0-.184.193-.3.336-.186.121.098.229.212.323.342l3.013 4.197c.068.096-.006.22-.124.22H12a.25.25 0 0 1-.25-.25V.823Z"
        />{" "}
      </svg>
    ),
  },
  // Add user profile item before logout
  {
    ...
    icon: (
      <div className="w-8 h-8 rounded-full bg-gray-300 flex items-center justify-center overflow-hidden">
        {" "}
        {/* This will be replaced with actual profile image */}{" "}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        <path
          fill="#000"
          d="M15.791 2h-6c-.55 0-1-.45-1-1s.45-1 1-1h6c1.1 0 2 .9 2 2v14c0 1.1-.9 2-2 2h-6c-.55 0-1-.45-1-1s.45-1 1-1h6V2Z"
        />{" "}
        <path
          fill="#000"
          d="m.141 8.65 2.79-2.79a.5.5 0 0 1 .86.35V8h7c.55 0 1 .45 1 1s-.45 1-1 1h-7v1.79c0 .45-.54.67-.85.35L.151 9.35c-.2-.19-.2-.51-.01-.7Z"
        />{" "}
      </svg>
    ),
  },
...
export const Sidebar = ({ role = "HR", userProfileImage = null }) => {
  ...
  const visibleItems =
    userRole === "newUser"
      ? []
      : sidebarItems
          .filter((item) => userRole === "HR" || item.role === "EMP")
          .map((item) => {
  ...
  const getActiveIndex = () => {
    if (currentPath.startsWith("/employee"))
      return visibleItems.findIndex((i) => i.label === "Employee Management");
    if (currentPath.startsWith("/projects"))
      return visibleItems.findIndex((i) => i.label === "Project Management");
    if (currentPath.startsWith("/courses"))
      return visibleItems.findIndex((i) => i.label === "Course Management");
    if (currentPath.startsWith("/dashboard"))
      return visibleItems.findIndex((i) => i.label === "Dashboard");
    if (currentPath.startsWith("/attendance"))
      return visibleItems.findIndex((i) => i.label === "Attendance");
    if (currentPath.startsWith("/upskill"))
      return visibleItems.findIndex((i) => i.label === "UpSkill");
    if (currentPath.startsWith("/documents"))
      return visibleItems.findIndex((i) => i.label === "Documents");
    if (currentPath.startsWith("/profile"))
      return visibleItems.findIndex((i) => i.label === "My Profile");
  ...
  if (isMobile) {
    return (
      <>
        ...
        {/* Mobile menu button */}
        <button
          className={`fixed top-[4rem] -left-3 z-[9999] w-12 h-12 bg-[#bcd4cd] rounded-full flex items-center justify-center shadow-lg transition-all duration-300 ${
        ...
        {/* Mobile sidebar */}
        <div
          className={`fixed top-0 left-0 h-screen bg-[#bcd4cd] text-black transition-all duration-300 ease-in-out z-[9999] ${
            mobileMenuOpen ? "w-screen" : "w-0"
          } overflow-hidden`}
        >
          <div className="flex极狐 flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto py-4">
              {visibleItems.map((item, index) => (
                <div
                  key={index}
                  className={`w-full px-6 py-4 cursor-pointer transition-all duration-200 flex items-center space-x-4 ${
                    index === activeIndex ? "bg-white/30" : "hover:bg-white/20"
                  }`}
    ...
    <>
      ...
      >
            ...
            style={{
              ...
              transform:
                sidebarState === 2 || sidebarState === 3
                  ...
                  : "scale(1)",
              transitionDelay:
                sidebarState === 2 || sidebarState === 3 ? "0ms" : "100ms",
            }}
          >
            ...
            style={{
              ...
              transform:
                sidebarState === 2 || sidebarState === 3
                  ...
                  : "scale(0.9)",
              transitionDelay:
                sidebarState === 2 || sidebarState === 3 ? "200ms" : "0ms",
            }}
          >
        ...
        {sidebarState === 1 && (
          ...
          >
            <span className="text-black font-bold text-lg transition-transform duration-200 hover:scale-110">
              &gt;
            </span>
          </div>
        )}
